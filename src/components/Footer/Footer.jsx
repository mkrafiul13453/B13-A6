...
const Footer = () => {
    return (
        <footer className="bg-[#0b0f19] text-white py-16 px-6 font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 text-base mb-8">
                        ...
                        <div className="flex gap-3">
                            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#0b0f19] hover:bg-gray-200 cursor-pointer transition-all">
